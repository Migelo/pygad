...
extern "C" void sph_bin_3D(size_t N, double *pos, double *hsml, double *dV, double *qty, double *extent, size_t Npx[3], double *grid,
                           const char *kernel_, double periodic);

extern "C" void sph_bin_3D_nonorm(size_t N, double *pos, double *hsml, double *dV, double *qty, double *extent, size_t Npx[3],
                                  double *grid, const char *kernel_, double periodic);

extern "C" void sph_3D_bin_2D(size_t N, double *pos, double *hsml, double *dV, double *qty, double *extent, size_t Npx[2],
                              double *grid, const char *kernel_, double periodic);

extern "C" void sph_3D_bin_2D_nonorm(size_t N, double *pos, double *hsml, double *dV, double *qty, double *extent, size_t Npx[2],
                                     double *grid, const char *kernel_, double periodic);

extern "C" void bin_sph_along_line(size_t N, double *pos, double *hsml, double *dV, double *qty, double *los, double *extent,
                                   size_t Npx, double *line, const char *kernel_, double periodic);
...
void bin_sph(size_t N, double *pos, double *hsml, double *dV, double *qty, double *extent, size_t Npx[d], double *grid,
             const char *kernel_, double periodic)
{
...
template <int d>
void bin_sph_line(size_t N, double *pos, double *hsml, double *dV, double *qty, double *los, double *extent, size_t Npx, double *line,
                  const char *kernel_, double periodic)
{
