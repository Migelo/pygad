...
extern "C" void bin_sph_proj_mean(size_t N, double *pos, double *hsml,
                                  double *dV, double *qty, double *av,
                                  double *extent, size_t Npx[2], double *grid,
                                  const char *kernel_, double periodic);

extern "C" void bin_sph_proj_median(size_t N, double *pos, double *hsml,
                                    double *dV, double *qty, double *av,
                                    double *extent, size_t Npx[2], double *grid,
                                    const char *kernel_, double periodic);

extern "C" void bin_sph_proj_stddev(size_t N, double *pos, double *hsml,
                                    double *dV, double *qty, double *av,
                                    double *extent, size_t Npx[2], double *grid,
                                    const char *kernel_, double periodic);

template <typename F>
void bin_sph_proj_by_particle(size_t N, double *pos, double *hsml, double *dV,
                              double *qty, double *av, double *extent,
                              size_t Npx[2], double *grid, const char *kernel_,
                              double periodic, F reduction_func,
                              double empty_val) {
  constexpr int d = 2;
