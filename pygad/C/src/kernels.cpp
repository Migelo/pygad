...
const char *kernel_name[NUM_DEF_KERNELS] = {
    ...
    "cubic",       "quartic", "quintic", "Wendland C2", "Wendland C4", "Wendland C6",
};
...
double _Wendland_C2_1D(double q) { return pow(1.0 - q, 3) * (1.0 + 3.0 * q); }
double _Wendland_C2_2D_3D(double q) { return pow(1.0 - q, 4) * (1.0 + 4.0 * q); }

double _Wendland_C4_1D(double q) { return pow(1.0 - q, 5) * (1.0 + 5.0 * q + 8.0 * q * q); }
double _Wendland_C4_2D_3D(double q) { return pow(1.0 - q, 6) * (1.0 + 6.0 * q + 35.0 / 3.0 * q * q); }

double _Wendland_C6_1D(double q) { return pow(1.0 - q, 7) * (1.0 + 7.0 * q + 19.0 * q * q + 21.0 * q * q * q); }
double _Wendland_C6_2D_3D(double q) { return pow(1.0 - q, 8) * (1.0 + 8.0 * q + 25.0 * q * q + 32.0 * q * q * q); }
