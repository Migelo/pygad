...
extern "C" void absorption_spectrum_multiple_los(bool particles,
                         size_t N,
                         double *pos,
                         double *vel,
                ...
                
{
  if(particles)
    {
      return _absorption_spectrum_multiple_los<true>(N, pos, vel, vpec_z, hsml, n, temp, rho, metal_frac, los_pos_arr, vel_extent, Nbins, Nlos, b_0, v_turb,
                                        Xsec, Gamma, taus, los_dens, los_dens_phys, los_metal_frac, los_temp, los_vpec, v_lims, column,
                                        kernel_, periodic);
      // DS: Added rho and los_dens_phys in the arguments of the function above
      // DS: Also vpec_z and los_vpec
    ...
    {
      return _absorption_spectrum_multiple_los<false>(N, pos, vel, vpec_z, hsml, n, temp, rho, metal_frac, los_pos_arr, vel_extent, Nbins, Nlos, b_0, v_turb,
                                         Xsec, Gamma, taus, los_dens, los_dens_phys, los_metal_frac, los_temp, los_vpec, v_lims,
                                         column, kernel_, periodic);
      // DS: Added rho and los_dens_phys in the arguments of the function above
      // DS: Also vpec_z and los_vpec
