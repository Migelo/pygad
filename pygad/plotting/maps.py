...
def plot_map(m, colors=None, extent=None, vlim=None, clim=None,
    ...
    Args:
        ...
        showcbar (bool):    Whether to add a colorbar (in the upper left corner
                            within the axis).
    ...
    if showcbar:
        ...
        cbar = add_cbar(ax, cbartitle, clim=clim, cmap=cmap,
                        ...
                        fontoutline=outline, nticks=7, bg_flag=bg_flag)
...
def image(s, qty=None, av=None, units=None, logscale=None, surface_dens=None,
          ...
          interpolation='nearest', maps=None, zero_is_white=False, surf_av=None,
          bg_flag=None, dispersion=None, sigToom=None, **kwargs):
    '''
...
def phase_diagram(s, rho_units='Msol/pc**3', T_units='K',
                  T_block='temp', T_threshold=None, rho_threshold=None,
